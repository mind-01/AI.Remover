        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex items-center justify-between mb-12">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-slate-900 uppercase tracking-tight leading-none mb-2">{t.title}</h1>
            ...
            {loading ? (
                ...
                <div className="bg-white rounded-[3rem] border border-slate-100 p-24 text-center">
                    ...
                    <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight mb-2">{t.emptyTitle}</h2>
                    <p className="text-slate-500 font-medium max-w-xs mx-auto text-sm">{t.emptyDesc}</p>
                    <button
                        onClick={onClose}
