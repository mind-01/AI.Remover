...
import { Zap, Shield, Image as ImageIcon, Download, CheckCircle2, Wand2, MousePointer2, Loader2, Sparkles, Cpu, Globe } from 'lucide-react';
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center space-y-6 mb-20">
                    <motion.h2
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="text-xs font-black text-blue-600 dark:text-blue-400 uppercase tracking-[0.4em]"
                    >
                        Questions?
                    </motion.h2>
                    <motion.h3
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: 0.1 }}
                        className="text-4xl font-black text-slate-800 tracking-tight dark:text-white"
                    >
